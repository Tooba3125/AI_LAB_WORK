...
first_out = Perceptron(2, [input1, input2], first_term, [weight1, weight2], bias=1, learning_rate=0.1)
second_out = Perceptron(2, [input1, input2], second_term, [weight1, weight2], learning_rate=0.1)
final_out = Perceptron(2, [first_term, second_term], xnor_term, [weight1, weight2], learning_rate=0.1)
first = first_out.training()
second = second_out.training()
final = final_out.training()
print(f"epochs\n\nA'B': {first}\nAB: {second}\nor: {final}\nxnor: {max(first,second)+final}")
